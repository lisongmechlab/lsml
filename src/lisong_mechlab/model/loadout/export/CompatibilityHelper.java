...
public class CompatibilityHelper{
   ...
   public static Item fixArtemis(final Item anItem, boolean aHasArtemis){
      ...
      Upgrades withArtemis = new Upgrades();
      Upgrades withoutArtemis = new Upgrades();
      stack.pushAndApply(new SetArtemisOperation(withArtemis, true));
      stack.pushAndApply(new SetArtemisOperation(withoutArtemis, false));
