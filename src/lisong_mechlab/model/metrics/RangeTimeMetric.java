...
public abstract class RangeTimeMetric implements Metric{
   ...
   /**
    * The {@link #calculate()} method will defer to this method for performing the actual calculations. This method must
    * not use the time returned by {@link #getTime()} or range returned by {@link #getRange()}; Doing so will result in
    * erroneous results.
    * 
    * @param aRange
