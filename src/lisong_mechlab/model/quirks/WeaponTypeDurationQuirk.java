...
/**
 * A quirk that affects the beam duration of all laser weapons.
 * 
 * @author Li Song
 *
 */
public class WeaponTypeDurationQuirk extends WeaponTypeQuirk {
    public WeaponTypeDurationQuirk(String aName, double aValue, HardPointType aType) {
