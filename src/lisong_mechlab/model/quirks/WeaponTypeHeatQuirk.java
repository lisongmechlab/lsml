...
/**
 * This quirk affects the heat of all weapons of a given type.
 * 
 * @author Li Song
 */
public class WeaponTypeHeatQuirk extends WeaponTypeQuirk {

    public WeaponTypeHeatQuirk(String aName, double aValue, HardPointType aType) {
