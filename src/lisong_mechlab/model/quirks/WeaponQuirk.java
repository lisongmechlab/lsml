...
/**
 * A base class for quirks that affect specific weapons.
 * 
 * @author Li Song
 */
public abstract class WeaponQuirk extends Quirk implements WeaponModifier {
    final private Weapon affected;

    /**
     * Creates a new quirk.
     * 
     * @param aName
     *            The user readable name of the quirk.
     * @param aValue
     *            The value of the quirk.
     * @param aAffectedWeapon
     *            The affected weapon.
     */
    public WeaponQuirk(String aName, double aValue, Weapon aAffectedWeapon) {
        super(aName, aValue);
        affected = aAffectedWeapon;
    }

    @Override
    public boolean affectsWeapon(Weapon aWeapon) {
        return aWeapon == affected;
    }
