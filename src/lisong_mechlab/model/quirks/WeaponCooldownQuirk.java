...
/**
 * A quirk that affects the cooldown of a weapon.
 * 
 * @author Emily Björk
 */
public class WeaponCooldownQuirk extends WeaponQuirk{
   public WeaponCooldownQuirk(String aName, double aValue, Weapon aAffectedWeapon) {
