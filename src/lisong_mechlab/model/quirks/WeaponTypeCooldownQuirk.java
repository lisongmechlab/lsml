...
/**
 * A quirk that affects all weapons of a given type.
 * @author Li Song
 *
 */
public class WeaponTypeCooldownQuirk extends WeaponTypeQuirk {

    public WeaponTypeCooldownQuirk(String aName, double aValue, HardPointType aType) {
