...
public class ChassisDBTest {
  ...
  public void testCanLoadBasicMech() {
    ...
    Assert.assertEquals("ILYA MUROMETS", cut.getName());
    Assert.assertEquals("CTF-IM", cut.getShortName());
    Assert.assertEquals(cut.getShortName(), cut.toString());
    Assert.assertEquals("ctf-im", cut.getKey());
  ...
  public void testCanLoadBasicMech2() {
    ...
    Assert.assertEquals("JENNER JR7-F", cut.getName());
    Assert.assertEquals("JR7-F", cut.getShortName());
    Assert.assertEquals(cut.getShortName(), cut.toString());
    Assert.assertEquals("jr7-f", cut.getKey());
  ...
  public void testCanLoadECMInfo() {
    ...
    Assert.assertEquals("ATLAS AS7-D-DC", cut.getName());
    Assert.assertEquals("AS7-D-DC", cut.getShortName());
    Assert.assertEquals(cut.getShortName(), cut.toString());
    Assert.assertEquals("as7-d-dc", cut.getKey());
