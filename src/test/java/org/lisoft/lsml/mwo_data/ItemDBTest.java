...
import org.lisoft.lsml.mwo_data.equipment.TargetingComputer;
import org.lisoft.lsml.mwo_data.modifiers.Modifier;

/**
 * This test suite doesn't as much test the behaviour of ItemDB but rather performs checks on the
 * data stored in the ItemDB.
 *
 * @author Li Song
 */
