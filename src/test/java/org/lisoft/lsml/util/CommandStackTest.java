...
public class CommandStackTest {
  ...
  /**
   * {@link CommandStack#nextRedo()} shall return the {@link Command} that would be done if {@link
   * CommandStack#redo()} was called now.
   */
  @Test
  ...
  /**
   * {@link CommandStack#nextUndo()} shall return the {@link Command} that would be undone if {@link
   * CommandStack#undo()} was called now.
   */
  @Test
  ...
  /**
   * {@link CommandStack#pushAndApply(Command)} shall push an {@link Command} and call it's {@link
