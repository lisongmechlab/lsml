...
public class CmdSetArmourTest {
	...
	/**
	 * Apply should correctly handle numerical precision problems that arise from
	 * armour amounts that result in irrational tonnages.
	 */
	@Test
	...
	/**
	 * Apply shall successfully change the armour value if called with an armour
	...
	/**
	 * Attempting to add armour that would cause the mass limit on the loadout to be
	 * exceeded shall result in an {@link EquipResult} when the operation is
	 * applied.
	 * <p>
	 * It must not be thrown on creation as there may be a composite operation that
	 * will be executed before this one that reduces the armour so that this
	...
	/**
	 * Attempting to set armour that is more than the side can support (but less
	 * than free tonnage) shall fail with an {@link EquipResult}.
	 */
	@Test(expected = EquipException.class)
	...
	/**
	 * Setting the armour automatically after an automatic set shall produce correct
	 * results.
	 */
	@Test
	...
	/**
	 * Setting the armour manually after an automatic set shall produce correct
	 * results.
	 */
	@Test
	...
	/**
	 * Setting the armour automatically after a manual set produce correct result
	 * and override manual set flag.
	 */
	@Test
	...
	/**
	 * Two set armour operations can coalesce if they refer to the same (equality is
	 * not enough) component, same side and have the same manual status.
	 */
	@Test
	...
	/**
	 * Any attempt to create an {@link CmdSetArmour} with negative armour shall
	 * throw an {@link IllegalArgumentException} on creation.
	 */
	...
	/**
	 * Any attempt to create a {@link CmdSetArmour} with more armour than the
	 * internal component can hold (100% failure regardless of current armour value)
	 * shall throw an {@link IllegalArgumentException} on construction.
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * Undoing twice to only one apply shall throw an instance of
	...
	/**
	 * Undoing when apply has not been called shall throw an instance of
	 * {@link RuntimeException}.
	 */
	@Test(expected = RuntimeException.class)
