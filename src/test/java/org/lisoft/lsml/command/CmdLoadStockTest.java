...
public class CmdLoadStockTest {
	...
	/**
	 * Loading stock shall succeed even if there is an automatic armour distribution
	 * going on.
	 */
	@Test
	...
	/**
	 * Loading stock configuration shall succeed even if the loadout isn't empty to
	 * start with.
	 */
	@Test
