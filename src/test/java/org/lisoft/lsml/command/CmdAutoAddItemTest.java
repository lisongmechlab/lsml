...
public class CmdAutoAddItemTest {
	...
	/**
	 * {@link CmdAutoAddItem} shall add an item to the first applicable slot in this
	 * loadout. Order the items are added is: RA, RT, RL, HD, CT, LT, LL, LA
	 */
	@Test
	...
	/**
	 * {@link CmdAutoAddItem} shall throw the correct error if the item is not
	 * feasible globally.
	 */
	@Test
	...
	/**
	 * {@link CmdAutoAddItem} shall try to move items in order to make room for the
	 * added item if there is no room in any component with a hard point but there
	 * are items that could be moved to make room.
	 */
	@Test
	...
	/**
	 * This test is a regression test for a bug where auto-add an ER PPC would fail
	 * on lsml://rRoAkQAAAAAAAAAAAAAAuihsbMzMbDCRE22zG2DF where a trivial solution
	 * is available.
	 */
	@Test
	...
	/**
	 * {@link CmdAutoAddItem} shall throw an {@link EquipResult} if the item cannot
	 * be auto added on any permutation of the loadout.
	 */
	...
	/**
	 * {@link CmdAutoAddItem} shall be able to swap items in addition to just moving
	 * one at a time. Otherwise there we miss some solutions.
	 */
	@Test
