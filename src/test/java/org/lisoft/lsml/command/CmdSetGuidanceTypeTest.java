...
public class CmdSetGuidanceTypeTest {
	...
	/**
	 * Apply shall change the {@link GuidanceUpgrade} of the {@link Upgrades}s
	 * object of the {@link LoadoutStandard} given as argument.
	 */
	@Test
	...
	/**
	 * Apply shall delegate to the upgrades object to change all Missile Weapons and
	 * Ammunition types.
	 */
	@Test
