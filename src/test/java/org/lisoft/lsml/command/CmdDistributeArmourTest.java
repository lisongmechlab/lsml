...
public class CmdDistributeArmourTest {
	...
	/**
	 * The operation shall succeed even if there is already max armour on the mech.
	 * (More on front parts than rear)
	 */
	@Test
	...
	/**
	 * The operator shall succeed at placing the armour points somewhere on an empty
	 * loadout.
	 */
	@Test
	...
	/**
	 * The operator shall not touch a manually set torso even if the attached arm
	 * contains items.
	 */
	@Test
	...
	/**
	 * The operator shall provide protection for components linking important
	 * components.
	 */
	@Test
	...
	/**
	 * The operator shall not barf if there is not enough free tonnage to
	 * accommodate the request. It shall allocate as much as possible to fill the
	 * loadout.
	 */
	@Test
	...
	/**
	 * The operator shall do nothing if the requested amount of armour is less than
	 * manually set amount.
	 */
	@Test
	...
	/**
	 * The operator shall take already existing armour amounts into account when
	 * deciding on how much armour to distribute.
	 */
	@Test
	...
	/**
	 * The operator shall not barf if the manually set armours take up more than the
	 * available budget.
	 */
	@Test
	...
	/**
	 * If the budget given is larger than can be assigned due to manually set parts,
	 * the operator shall assign max armour to the remaining parts.
	 */
	@Test
	...
	/**
	 * The operation shall round down to the closest half ton, even if quarter ton
	 * items are present.
	 */
	@Test
