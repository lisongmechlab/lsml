...
public class CmdAddItemTest {
  ...
  @Mock private MessageDelivery msgDelivery;
  ...
  /**
   * Adding an item shall be possible if the loadout and component supports it. Necessary
   * manipulation of the component and sending of messages is done in proper order.
   */
  @Test
  ...
  /**
   * Operation will fail with a {@link EquipResult} exception if the component cannot support the
   * item.
   */
  @Test
  ...
  /**
   * Operation will fail with a {@link EquipResult} exception if the loadout cannot support the
   * item.
   */
  @Test
  ...
  /**
   * C.A.S.E. together with an engine where one side can be lost should not generate a warning
   * notice.
   */
  @Test
