...
public class CmdAddItemTest {
	...
	/**
	 * Adding an item shall be possible if the loadout and component supports it.
	 * Necessary manipulation of the component and sending of messages is done in
	 * proper order.
	 */
	@Test
	...
	/**
	 * Only two GaussRifles can be charged simultaneously. Emit a warning if a third
	 * is added.
	 */
	@Test
	...
	/**
	 * Operation will fail with a {@link EquipResult} exception if the component
	 * cannot support the item.
	 */
	@Test
	...
	/**
	 * Operation will fail with a {@link EquipResult} exception if the loadout
	 * cannot support the item.
	 */
	@Test
	...
	/**
	 * If an item can't be added, an exception shall be thrown when the operation is
	 * applied.
	 */
