...
/**
 * To test the back-tracking algorithm we need a non-trivial problem that preferably has one unique
 * solution. The only thing that came to mind was Suudoku.
 *
 * @author Li Song
 */
public class BackTrackingSolverTest {
  ...
  public void testSolveSudoku() {
    ...
    int[] grid =
        new int[] { // Comments to enforce line breaks
          1, E, E, E, E, 2, E, E, E, //
          E, 5, E, E, 9, E, 2, E, 4, //
          E, E, E, E, E, 6, 7, E, E, //
          E, 3, 4, E, E, 1, E, E, 5, //
