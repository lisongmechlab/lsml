...
public class DynamicSlotDistributorTest {
    ...
    public void testGetDynamicArmourSlots() {
        ...
        when(armourType.getExtraSlots()).thenReturn(armourSlots);
    ...
    public void testGetDynamicArmourSlots_StdArmour() {
        ...
        when(loadout.getUpgrades()).thenReturn(upgrades);
        when(upgrades.getArmour()).thenReturn(armourType);
        when(armourType.getExtraSlots()).thenReturn(0);
    ...
    //
    // /**
    // * Calculates the cumulative number of slots that are free up until the argument according to the priority order
    // of
    // * components.
    // *
    // * @param aPart
    ...
    //
    // /**
    // * Calculates the number of cumulative slots that are occupied by dynamic slots given the maximum number of
    // dynamic
