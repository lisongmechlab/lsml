...
public class ConfiguredComponentOmniMechTest extends ConfiguredComponentTest {
  ...
  public void testCanEquip_DynamicSlots() {
    ...
    assertEquals(
        EquipResult.make(location, EquipResultType.NotEnoughSlots),
  ...
  /**
   * The {@link ConfiguredComponentOmniMech#changeOmniPod(OmniPod)} shall throw {@link
  ...
  public final void testChangeOmniPodFixed() {
    ...
    final ConfiguredComponentOmniMech cut =
        new ConfiguredComponentOmniMech(omniInternal, manualArmour);
    final OmniPod omniPod2 = mock(OmniPod.class);
