...
public class WeaponGroupsTest {
	...
	/**
	 * Test that a weapon can be in many groups and any group can have multiple
	 * weapons.
	 */
	@Test
	...
	/**
	 * Test that weapons are returned in the order of the iterator of
	 * loadout.item(weapon) and that only offensive weapons are included.
	 */
	@Test
