...
public class RangeTimeMetricTest {
  ...
  /**
   * A call to {@link RangeTimeMetric#calculate()} after {@link
   * RangeTimeMetric#setUserRange(double)} has been called with a positive, non-negative argument
   * should return the value of {@link RangeTimeMetric#calculate(double, double)} called with the
   * same argument as {@link RangeTimeMetric#setUserRange(double)} was called.
   */
  @Test
  ...
  /**
   * If {@link RangeTimeMetric#setUserRange(double)} was last called with a negative or zero
   * argument; a call to {@link RangeTimeMetric#calculate()} should return the maximum value of
   * {@link RangeTimeMetric#calculate(double, double)} for all the ranges returned by {@link
  ...
  /**
   * If {@link RangeTimeMetric#setUserRange(double)} has not been called; a call to {@link
   * RangeTimeMetric#calculate()} should return the maximum value of {@link
   * RangeTimeMetric#calculate(double, double)} for all the ranges returned by {@link
   * WeaponRanges#getRanges(Loadout)}.
   */
  @Test
  ...
  /**
   * After a call to {@link RangeTimeMetric#calculate()}, {@link RangeTimeMetric#getUserRange()}
   * should return the range for which {@link RangeTimeMetric#calculate(double, double)} returned
   * the highest value of the ranges determined by the weapons on the loadout.
   */
  @Test
  ...
  /**
   * {@link RangeTimeMetric#getTime()} shall return the value of the last call to {@link
   * RangeTimeMetric#changeTime(double)}.
   */
  @Test
