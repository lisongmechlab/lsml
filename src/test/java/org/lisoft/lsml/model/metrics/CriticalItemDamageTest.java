...
public class CriticalItemDamageTest {
     ...
     * take into account the number of hits from a critical hit. A 3-roll critical strike has 3 chances to hit this
     * item. The probability that the item will be hit is X~bin(n,p) where n is the number of rolls and p is the chance
     * that the item will be hit in the roll. The binomial probability needs to be weighted with the number of hits. For
