...
public class HeatDissipationTest {
	...
	/**
	 * The heat dissipation of a 'mech is dependent on the heat sink types. > For
	 * single heat sinks it is simply the number of heat sinks multiplied by any
	 * modifier from the efficiencies. > For double heat sinks it each engine
