...
public class MaxSustainedDPSTest {
  ...
  /**
   * Damage shall be correctly calculated, taking high DpH weapons into account first regardless of
  ...
  public void testCalculate() throws Exception {
    ...
    final double heat =
        gauss.getStat("h/s", null) + erppc.getStat("h/s", null) * 1.5 + llas.getStat("h/s", null);
    ...
    final double expected =
        gauss.getStat("d/s", null) + erppc.getStat("d/s", null) * 1.5 + llas.getStat("d/s", null);
