...
public class CriticalStrikeProbabilityTest {
	...
	/**
	 * Easy case. When there is only one item, the chance to crit is the sum of the
	 * crit probabilities for 1, 2 and 3 hits.
	 */
	@Test
	 ...
	 * <p>
	 * There are four disjunct cases that can happen: 0 hits, 1 hit, 2 hits, 3 hits
	 * with 58%, 25%, 14% and 3% probability respectively (sum 100%). The chance
	 * that the item is hit by at least one of those hits is the weighted sum of the
	 * above cases as they are disjunct. I.e.
	 * <p>
	 * P_atleastonce = 0.58*0 + 0.25*P_hit + 0.14*(1-(1-P_hit)^2) +
	 * 0.03*(1-(1-P_hit)^3)
	 */
	@Test
