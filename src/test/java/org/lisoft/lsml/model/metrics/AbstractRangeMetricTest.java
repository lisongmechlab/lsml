...
public class AbstractRangeMetricTest {
	...
	/**
	 * A call to {@link AbstractRangeMetric#calculate()} after
	 * {@link AbstractRangeMetric#setUserRange(double)} has been called with a
	 * positive, non-negative argument should return the value of
	 * {@link AbstractRangeMetric#calculate(double)} called with the same argument
	 * as {@link AbstractRangeMetric#setUserRange(double)} was called.
	 */
	@Test
	...
	/**
	 * If {@link AbstractRangeMetric#setUserRange(double)} was last called with a
	 * negative or zero argument; a call to {@link AbstractRangeMetric#calculate()}
	 * should return the maximum value of
	...
	/**
	 * If {@link AbstractRangeMetric#setUserRange(double)} has not been called; a
	 * call to {@link AbstractRangeMetric#calculate()} should return the maximum
	 * value of {@link AbstractRangeMetric#calculate(double)} for all the ranges
	 * returned by {@link WeaponRanges#getRanges(Loadout)}.
	 *
	 */
	@Test
	...
	/**
	 * After a call to {@link AbstractRangeMetric#calculate()},
	 * {@link AbstractRangeMetric#getDisplayRange()} should return the range for
	 * which {@link AbstractRangeMetric#calculate(double)} returned the highest
	 * value of the ranges determined by the weapons on the loadout.
	 */
	@Test
