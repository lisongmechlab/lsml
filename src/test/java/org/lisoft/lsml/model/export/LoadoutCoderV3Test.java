...
public class LoadoutCoderV3Test {
  ...
  /**
   * Even if heat sinks are encoded before the engine for CT, the heat sinks shall properly appear
   * as engine heat sinks.
   */
  @Test
  public void testDecodeHeatsinksBeforeEngine() throws DecodingException {
    ...
    final Loadout l =
        cut.decode(
            base64.decode(
                "rgARREYOMRJoFEYOMUTne6/upzrLydT6fsxT6z64t7j1VaIokEgkCbPp9PlsxT65OQ5Zsg=="));
  ...
  /**
   * Test that we can decode a loadout that contains old pilot modules after they were removed from
   * the game.
   */
  @Test
  public void testDecodeWithPilotModule() throws Exception {
    ...
    cut.decode(
        base64.decode(
            "rgCzAAAAAAAAAAAAAAAA6zHWZdZdZdZdZdZdSpVd3KlSq66untdjKlSq62uoy6y6y6y6y6y6lSr+2f6M"));
  ...
  public void testIssue481() throws DecodingException {
    final Decoder base64 = java.util.Base64.getDecoder();
    final Loadout l =
        cut.decode(base64.decode("rgEoHCQILBIsDCQILBwD6yzxWKqd5EX4qp3yndbTw4jSVTvdO/Yl"));
