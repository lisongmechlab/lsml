...
public class Base64LoadoutCoderTest {
	...
	/**
	 * Passing in a string without a protocol identifier is assumed to be LSML
	 * format with protocol identifier stripped. Test for V2 links.
	 */
	@Test
	...
	/**
	 * Passing in a string without a protocol identifier is assumed to be LSML
	 * format with protocol identifier stripped. Test for V3 links.
	 */
	@Test
