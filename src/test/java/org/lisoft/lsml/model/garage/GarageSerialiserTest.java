...
public class GarageSerialiserTest {
	...
	private final GarageSerialiser cut = new GarageSerialiser(erc, loadoutFactory);
	...
	/**
	 * Check that we can load a garage from LSML 1.7.2 with all stock loadouts
	 * and IS + CLAN drop ships.
	 *
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Even if DHS are serialised before the Engine, they should be added as
	 * engine heat sinks.
	 */
	@Test
