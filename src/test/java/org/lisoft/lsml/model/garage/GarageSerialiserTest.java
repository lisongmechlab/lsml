...
public class GarageSerialiserTest {
	...
	/**
	 * Check that we can load a garage from LSML 1.7.2 with all stock loadouts and
	 * IS + CLAN drop ships.
	 */
	@Test
	...
	/**
	 * Even if DHS are serialised before the Engine, they should be added as engine
	 * heat sinks.
	 */
	@Test
