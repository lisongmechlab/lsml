  ...
  public void testGetDataTwoWeapons() {
    ...
    for (final Weapon weapon : weapons) {
      if (weapon == nonOffensive) {
        ...
        assertEquals(
            rangeEff.apply(0.0) * dps * ratios.get(weapon), series.get(0).second, tolerance);
        assertEquals(
            rangeEff.apply(10.0) * dps * ratios.get(weapon), series.get(1).second, tolerance);
        assertEquals(
            rangeEff.apply(11.0) * dps * ratios.get(weapon), series.get(2).second, tolerance);
        assertEquals(
            rangeEff.apply(20.0) * dps * ratios.get(weapon), series.get(4).second, tolerance);
        assertEquals(
            rangeEff.apply(21.0) * dps * ratios.get(weapon), series.get(6).second, tolerance);
        assertEquals(
            rangeEff.apply(30.0) * dps * ratios.get(weapon), series.get(7).second, tolerance);
        assertEquals(
            rangeEff.apply(31.0) * dps * ratios.get(weapon), series.get(8).second, tolerance);
        assertEquals(
            rangeEff.apply(40.0) * dps * ratios.get(weapon), series.get(9).second, tolerance);
        assertEquals(
            rangeEff.apply(41.0) * dps * ratios.get(weapon), series.get(10).second, tolerance);
      }
    }
