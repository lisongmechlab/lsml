...
/**
 * This {@link MovementProfile} provides an abstract base for a composite {@link MovementProfile}
 * where the value of each attribute is the result a function applied to a set of {@link
 * MovementProfile}s.
 *
 * @author Li Song
 */
