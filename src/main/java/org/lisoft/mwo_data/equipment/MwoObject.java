...
public class MwoObject {
  @XStreamAsAttribute private final String description;
  @XStreamAsAttribute private final Faction faction;
  @XStreamAsAttribute private final int mwoId;
  @XStreamAsAttribute private final String mwoKey;
  @XStreamAsAttribute private final String name;
  @XStreamAsAttribute private final String shortName;
