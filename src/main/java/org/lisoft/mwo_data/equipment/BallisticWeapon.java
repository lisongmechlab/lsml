...
public class BallisticWeapon extends AmmoWeapon {
  @XStreamAsAttribute protected final double chargeTime;
  @XStreamAsAttribute protected final Attribute jamRampDownTime;
  @XStreamAsAttribute protected final double jamRampUpTime;
  @XStreamAsAttribute protected final Attribute jammingChance;
  @XStreamAsAttribute protected final Attribute jammingTime;
  @XStreamAsAttribute protected final double rampDownDelay;
  @XStreamAsAttribute protected final double rampDownTime;
  @XStreamAsAttribute protected final double rampUpTime;
  @XStreamAsAttribute protected final int shotsDuringCoolDown;
  ...
  public BallisticWeapon(
      ...
      int aAmmoPerShot,
      // Ballistic Arguments
      Attribute aJammingChance,
      Attribute aJammingTime,
      int aShotsDuringCoolDown,
      double aChargeTime,
      double aRampUpTime,
      double aRampDownTime,
      double aRampDownDelay,
      double aJamRampUpTime,
  ...
  public double getExpectedFiringPeriod(Collection<Modifier> aModifiers) {
    if (canJam()) {
      ...
      if (rampUpTime != 0.0) {
        ...
        // p_k must have form: "jamP*(1-jamP)^k for k=0...+inf" to terminate each success string
        // with a failure.
   ...
   */
  public double getJamRampUpTime() {
