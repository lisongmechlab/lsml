...
/**
 * This class implements {@link org.lisoft.lsml.messages.Message}s for the {@link Garage} so that
 * other components can react to changes in the garage.
 *
...
public class GarageMessage<T extends NamedObject> implements Message {
  ...
  public boolean equals(Object obj) {
    if (obj instanceof final GarageMessage<?> that) {
