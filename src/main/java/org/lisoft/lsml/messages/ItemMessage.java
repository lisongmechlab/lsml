...
public class ItemMessage implements Message {
   ...
   * @param aRelativeIndex The index among the equipped items of the affected component of the new
   *     or old position for addition or removal respectively. For toggleable items, negative values
   *     are used.
