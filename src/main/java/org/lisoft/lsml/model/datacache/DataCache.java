...
public class DataCache {
    ...
    public static XStream makeDataCacheXStream() {
    ...
    public DataCache(String aLsmlVersion, Map<String, Long> aChecksums, List<Item> aItems, List<Upgrade> aUpgrades,
    ...
    /**
     * @return The LSML version that this cache is compatible with.
     */
