...
/**
 * This class handles distribution of dynamic slots from Ferro Fibrous armour
 * and Endo Steel internal structure.
 * <p>
 * It only tells you how many slots of each type should be visualised for a
 * given part. It doesn't actually add any thing to those parts.
 * <p>
 * This class will transparently handle the fact that some slots are fixed per
 * location on omnimechs.
 *
 * @author Li Song
 */
public class DynamicSlotDistributor {
	...
	/**
	 * Creates a new {@link DynamicSlotDistributor} for the given
	 * {@link Loadout}.
	 *
	 * @param aLoadout
	...
	/**
	 * Returns the number of dynamic armour slots that should be visualised for
	 * the given {@link ConfiguredComponent} .
	 *
	 * @param aLocation
	...
	/**
	 * Returns the number of dynamic structure slots that should be visualised
	 * for the given {@link ConfiguredComponent} .
	 *
	 * @param aLocation
	 *            The {@link Location} to get results for.
	 * @return A number of slots to display, can be 0.
	...
	/**
	 * Gets the number of cumulative free slots up until the argument. Taking
