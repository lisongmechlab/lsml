...
public abstract class HeatSource extends Item {
    ...
    protected HeatSource(
        ...
        double aHP, Faction aFaction, List<Location> aAllowedLocations, List<ChassisClass> aAllowedChassisClasses,
    ...
    /**
     * Returns an integrated signal that can be used to determine how much heat is generated over
     * time, on average, by this item if it is constantly activated.
     *
     * @param aModifiers A {@link Collection} of {@link Modifier}s that could affect the heat generation.
     * @return An {@link IntegratedSignal} that represents the amount of heat over time.
     */
    public abstract IntegratedSignal getExpectedHeatSignal(Collection<Modifier> aModifiers);
