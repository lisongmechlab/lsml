...
/**
 * This class handles conversions of {@link LoadoutStandard}s to and from Base64
 * strings. It will correctly determine which format the string is in and choose
 * the right combination of decoders.
 *
 * @author Emily Björk
 */
@Singleton
public class Base64LoadoutCoder {
	...
	/**
	 * Will encode a given {@link Loadout} into a HTTP trampoline LSML protocol
	 * {@link String}.
	 *
	 * @param aLoadout
	 *            The {@link Loadout} to encode.
	 * @return A HTTP URI as a {@link String} with a Base64 encoding of the
	 ...
	 * @param aLoadout
	 *            The {@link Loadout} to encode.
	 * @return A {@link String} with a Base64 encoding of the
	 *         {@link LoadoutStandard}.
	 */
