...
public class ModifierDescription {
  ...
  public static final Collection<String> SEL_AMMOCAPACITY = uc("ammocapacity");
  public static final Collection<String> SEL_ARMOUR_RESIST = uc("armorresist");
  public static final Collection<String> SEL_ARMOUR_STEALTH_COOLDOWN = uc("stealtharmorcooldown");
  ...
  public static final Collection<String> SEL_CONSUMABLE_UAVS = uc("uavcapacity");
  public static final Collection<String> SEL_CONSUMABLE_UAV_RANGE = uc("uavrange");
  public static final Collection<String> SEL_CRIT_CHANCE = uc("critchance");
  ...
  public static final Collection<String> SEL_HEAT_EXTERNALTRANSFER = uc("externalheat");
  ...
  public static final Collection<String> SEL_MOVEMENT_ACCELLERP = uc("accellerp");
  ...
  public static final Collection<String> SEL_MOVEMENT_DECELLERP = uc("decellerp");
  ...
  public static final Collection<String> SEL_MOVEMENT_JUMPJETS = uc("jumpjets");
  ...
  public static final String SPEC_CRIT_RECEIVING = "receiving";
  public static final String SPEC_JUMPJETS_BURN_TIME = "burntime";
  public static final String SPEC_JUMPJETS_INITIAL_THRUST = "initialthrust";
  public static final String SPEC_MOVEMENT_PITCHANGLE = "pitchangle";
  public static final String SPEC_MOVEMENT_PITCHSPEED = "pitchspeed";
  public static final String SPEC_MOVEMENT_YAWANGLE = "yawangle";
  public static final String SPEC_MOVEMENT_YAWSPEED = "yawspeed";
  ...
  /**
   * This method checks if a specifier affects an attribute that LSML knowns about. This is mostly
