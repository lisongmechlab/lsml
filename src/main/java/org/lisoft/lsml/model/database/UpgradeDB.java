...
public class UpgradeDB {
	...
	/**
	 * A decision has been made to rely on static initialisers for *DB classes. The
	 * motivation is that all items are immutable, and this is the only way that
	 * allows providing global item constants such as ItemDB.AMS.
	 */
	static {
	 ...
	 * @return A {@link ArmourUpgrade} suitable for 'Mechs of the given
	 *         {@link Faction}.
	 */
	 ...
	 * @return A {@link GuidanceUpgrade} suitable for 'Mechs of the given
	 *         {@link Faction}.
	 */
	 ...
	 * @return A {@link HeatSinkUpgrade} suitable for 'Mechs of the given
	 *         {@link Faction}.
	 */
	 ...
	 * @return A {@link StructureUpgrade} suitable for 'Mechs of the given
	 *         {@link Faction}.
	 */
	 ...
	 * @return A {@link Upgrade} of the type <code>T</code> which is the default for
	 *         the given faction.
	 */
	...
	/**
	 * Finds all the upgrades of the given type that are usable on the given
	 * chassis.
	 *
	 * @param aChassis
