...
public class ChassisDB {
	...
	/**
	 * A decision has been made to rely on static initializers for *DB classes. The
	 ...
	 * @return An {@link List} of all {@link ChassisStandard} with the given
	 *         {@link ChassisClass}.
	 */
	 ...
	 * @return A {@link List} of all variants of this chassis (normal, champion,
	 *         phoenix etc)
	 */
