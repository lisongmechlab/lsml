...
public class ItemStatsMascStats {
     ...
     *
     * @param aStats The stats object to generate the item from.
     * @return a {@link MASC}.
     */
    public MASC asMasc(ItemStatsModule aStats) {
        return new MASC(aStats.getUiName(), aStats.getUiDescription(), aStats.getMwoKey(), aStats.getMwoId(),
                        aStats.ModuleStats.slots, aStats.ModuleStats.tons, aStats.ModuleStats.health,
                        aStats.getFaction(), aStats.ModuleStats.amountAllowed, aStats.ModuleStats.TonsMin,
                        aStats.ModuleStats.TonsMax, BoostSpeed, BoostAccel, BoostDecel, BoostTurn);
    }
