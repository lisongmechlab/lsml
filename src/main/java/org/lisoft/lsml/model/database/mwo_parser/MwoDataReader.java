...
/**
 * This is the main entry point for the parsing of the gamefiles. Most of the heavy lifting
 * is done by the {@link PartialDatabase} class that contains the state of parsing as it
 * progresses and finally packages that into a {@link Database} object.
 *
 * The continued existence of this class is an open question. It's existence doesn't really
 * feel motivated after most of the code moved into {@link PartialDatabase} as part of a
 * cleanup aimed at getting rid of many cast from Object and simplifying function signatures.
 *
 * @author Li Song
 */
