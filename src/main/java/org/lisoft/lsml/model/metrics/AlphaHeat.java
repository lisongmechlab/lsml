...
public class AlphaHeat implements Metric {
  ...
  /**
   * Creates a new {@link AlphaHeat} that calculates the alpha strike damage for a given loadout
   * using all weapons.
   *
  ...
  /**
   * Creates a new {@link AlphaHeat} metric that calculates the alpha strike for the given weapon
   * group.
   *
   * @param aLoadout The loadout to calculate for.
