...
/**
 * This {@link Metric} calculates the asymptotic heat generation per second for a {@link
 * LoadoutStandard}.
 *
 * <p>It accounts for the heat generated by the engine at 100% throttle but not for jump jets.
 *
 * @author Li Song
 */
public class HeatGeneration implements Metric {
  ...
  /**
   * Creates a new metric that calculates the heat generation for a given weapon group, including
   * fixed heat sources such as engine.
   *
