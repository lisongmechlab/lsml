...
public class DropShip extends NamedObject {
  public static final int MAX_CLAN_TONNAGE = 240;
  public static final int MAX_IS_TONNAGE = 250;
  public static final int MECHS_IN_DROPSHIP = 4;
  public static final int MIN_CLAN_TONNAGE = 160;
  public static final int MIN_IS_TONNAGE = 160;
   ...
   *
   * @param aBayIndex The index of the mech to get, must be less than {@link
   *     DropShip#MECHS_IN_DROPSHIP} but larger than or equal to zero.
   ...
   *
   * @param aBayIndex The index of the bay to store the 'Mech in. Must be less than {@link
   *     DropShip#MECHS_IN_DROPSHIP} but larger than or equal to zero.
   * @param aLoadout The loadout to add.
   * @throws GarageException If the loadout has the wrong faction for this drop ship or if the drop
   *     ship is full already.
   */
