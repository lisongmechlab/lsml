...
import static org.lisoft.lsml.mwo_data.modifiers.ModifierDescription.*;
...
public class BaseMovementProfile implements MovementProfile {
  ...
  public BaseMovementProfile(
    ...
    reverseSpeedMultiplier = new Attribute(aReverseSpeedMultiplier, SEL_MOVEMENT_MAX_REV_SPEED);

    torsoTurnSpeedYaw =
        new Attribute(aTorsoTurnSpeedYaw, SEL_MOVEMENT_TORSO, SPEC_MOVEMENT_YAW_SPEED);
    torsoTurnSpeedPitch =
        new Attribute(aTorsoTurnSpeedPitch, SEL_MOVEMENT_TORSO, SPEC_MOVEMENT_PITCH_SPEED);
    maxTorsoAngleYaw =
        new Attribute(aMaxTorsoAngleYaw, SEL_MOVEMENT_TORSO, SPEC_MOVEMENT_YAW_ANGLE);
    maxTorsoAnglePitch =
        new Attribute(aMaxTorsoAnglePitch, SEL_MOVEMENT_TORSO, SPEC_MOVEMENT_PITCH_ANGLE);

    armTurnSpeedYaw = new Attribute(aArmTurnSpeedYaw, SEL_MOVEMENT_ARM, SPEC_MOVEMENT_YAW_SPEED);
    armTurnSpeedPitch =
        new Attribute(aArmTurnSpeedPitch, SEL_MOVEMENT_ARM, SPEC_MOVEMENT_PITCH_SPEED);
    maxArmRotationYaw =
        new Attribute(aMaxArmRotationYaw, SEL_MOVEMENT_ARM, SPEC_MOVEMENT_YAW_ANGLE);
    maxArmRotationPitch =
        new Attribute(aMaxArmRotationPitch, SEL_MOVEMENT_ARM, SPEC_MOVEMENT_PITCH_ANGLE);

    turnLerpLowSpeed = new Attribute(aTurnLerpLowSpeed, SEL_MOVEMENT_TURN_SPEED, SPEC_LOW_RATE);
    turnLerpMidSpeed = new Attribute(aTurnLerpMidSpeed, SEL_MOVEMENT_TURN_SPEED, SPEC_MID_RATE);
    turnLerpHighSpeed = new Attribute(aTurnLerpHighSpeed, SEL_MOVEMENT_TURN_SPEED, SPEC_HIGH_RATE);
    turnLerpLowRate = new Attribute(aTurnLerpLowRate, SEL_MOVEMENT_TURN_RATE, SPEC_LOW_RATE);
    turnLerpMidRate = new Attribute(aTurnLerpMidRate, SEL_MOVEMENT_TURN_RATE, SPEC_MID_RATE);
    turnLerpHighRate = new Attribute(aTurnLerpHighRate, SEL_MOVEMENT_TURN_RATE, SPEC_HIGH_RATE);
