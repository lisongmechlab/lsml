...
public class ComponentOmniMech extends Component {
  @XStreamAsAttribute private final int dynamicArmour;
  @XStreamAsAttribute private final int dynamicStructure;
   ...
   * @param aFixedOmniPod If this component has a fixed {@link OmniPod}, a reference to said {@link
   *     OmniPod} otherwise <code>null</code> if the {@link OmniPod} can be changed.
   * @param aFixedItems An array of fixed {@link Item}s for this component.
   * @param aDynamicStructureSlots An array where each element represents the ordinal of a {@link
   *     Location} and how many dynamic structure slots are fixed at that location.
   * @param aDynamicArmourSlots An array where each element represents the ordinal of a {@link
   *     Location} and how many dynamic armour slots are fixed at that location.
   */
  public ComponentOmniMech(
      Location aLocation,
      int aCriticalSlots,
      Attribute aHitPoints,
      List<Item> aFixedItems,
      OmniPod aFixedOmniPod,
      int aDynamicStructureSlots,
      int aDynamicArmourSlots) {
  ...
  /**
   * @return If this component has a fixed {@link OmniPod}, it returns the {@link OmniPod}.
  ...
  /**
   * @return True if this {@link ComponentOmniMech} has a fixed {@link OmniPod} that can't be
   *     changed.
   */
