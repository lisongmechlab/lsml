...
/**
 * This movement profile gives the minimum possible value of a combination of different movement
 * profiles.
 *
 * <p>More specifically, a base profile is defined (typically chassis standard values) and a number
 * of alternatives are given in groups. For each group the lowest value among the alternatives is
