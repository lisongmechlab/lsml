...
public abstract class Component {
  @XStreamImplicit private final List<Item> fixedItems;
  @XStreamAsAttribute private final Attribute hitpoints;
   ...
   */
  public Component(
      int aCriticalSlots, Attribute aHitPoints, Location aLocation, List<Item> aFixedItems) {
  ...
  /**
   * Checks if a specific item is allowed on this component checking only local, static constraints.
   * This method is only useful if {@link Chassis#isAllowed(Item)} returns true.
   *
   * @param aItem The {@link Item} to check.
   * @return <code>true</code> if the given {@link Item} is allowed on this {@link
   *     ComponentStandard}.
   */
