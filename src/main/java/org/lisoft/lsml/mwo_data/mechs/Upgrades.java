...
/**
 * This class is a simple container that manages upgrades for a loadout.
 *
 * @author Li Song
 */
public class Upgrades {
  ...
  public Upgrades(Upgrades aUpgrades) {
    this(
        aUpgrades.armourType,
        aUpgrades.structureType,
        aUpgrades.guidanceType,
        aUpgrades.heatSinkType);
  }
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof final Upgrades other)) {
      return false;
    }
    return armourType == other.armourType
        && guidanceType == other.guidanceType
        && heatSinkType == other.heatSinkType
  ...
  public <T extends Upgrade> T getUpgradeOfType(Class<T> aClass) {
    ...
    throw new IllegalArgumentException(
        "getUpgradeOfType must be called with an upgrade type class!");
  }
