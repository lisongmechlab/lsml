...
/**
 * This enumeration represents the weight class of a chassis: Light, Medium, Heavy or Assault. It
 * provides a way to determine weight class from tonnage.
 *
 * @author Li Song
 */
public enum ChassisClass {
  ...
  private static final double TONNAGE_EPSILON = Math.ulp(100) * 5.0;
