...
public class Attribute {
  ...
  @XStreamAsAttribute private final String specifier;
  @XStreamAsAttribute private double baseValue;
   ...
   * @param aBaseValue The base value of the attribute.
   * @param aSelectors The list of selectors that can be matched to modifiers.
   * @param aSpecifier The name of the attribute, or <code>null</code> if the attribute is
   *     implicitly understood from the selector(s). Must not be non-null and empty.
   */
  ...
  public boolean equals(Object aObj) {
    if (!(aObj instanceof final Attribute that)) {
      return false;
    }
  ...
  /**
   * @return The name of this attribute. May be <code>null</code> if the name is implicitly
   *     understood from the selector(s). If it is non-<code>null</code> it is not empty.
   */
  ...
  /**
   * @param aModifiers A {@link Collection} of {@link Modifier} that should be applied (if
   *     applicable) to this attribute.
   * @return The value of this {@link Attribute} after applying the {@link Modifier}s that affect
   *     this attribute from the given list.
   */
      ...
      for (final Modifier modifier : aModifiers) {
        if (modifier.getDescription().affects(this)) {
          ...
          switch (op) {
            ...
            case MUL -> multiplicative += modifier.getValue();
            default -> throw new IllegalArgumentException("Unhandled operation: " + op);
          }
        }
      }
    }
