...
public class Weapon extends HeatSource {
  ...
  /**
   * Gets the cooldown value as show in-game. For single shot weapons, this can be positive
   ...
   *
   * <p>Please note that this is not the same as cooldown for all weapons. The firing period
   ...
   * from a string.
   *
   * <p>Format: d=damage, s=seconds, t=tons, h=heat, c=critical slots, r=raw cooldown
   *
