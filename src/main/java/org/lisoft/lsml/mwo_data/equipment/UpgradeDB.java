...
public class UpgradeDB {
   ...
   * @return A {@link Upgrade} of the type <code>T</code> which is the default for the given
   *     faction.
   */
  ...
  public static GuidanceUpgrade getGuidance(
      @SuppressWarnings("unused") Faction aFaction, boolean aUpgraded) {
