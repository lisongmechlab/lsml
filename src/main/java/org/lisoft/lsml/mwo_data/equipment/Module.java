...
public class Module extends Item {
   ...
   * hit the limit you need to see if the item to be equipped has an {@link
   * #getAllowedAmountOfType()} attribute and then count the number of items for which {@link
   * #isSameTypeAs(Item)} returns true.
   *
