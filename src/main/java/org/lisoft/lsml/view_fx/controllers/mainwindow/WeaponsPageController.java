  ...
  public WeaponsPageController() {
    ...
    addStatColumn(
        ...
        """
                        ...
                        This is cool down plus burn time of lasers, charge time of gauss etc.
    ...
    range90LB.setCellValueFactory(
        aFeatures -> {
          final WeaponRangeProfile.Range pctRange =
              aFeatures.getValue().getRangeProfile().getPercentileRange(0.9, null);
          return FxBindingUtils.formatValue(FxTableUtils.STAT_FMT, false, pctRange.minimum);
        });
    ...
    range90UB.setCellValueFactory(
        aFeatures -> {
          final WeaponRangeProfile.Range pctRange =
              aFeatures.getValue().getRangeProfile().getPercentileRange(0.9, null);
          return FxBindingUtils.formatValue(FxTableUtils.STAT_FMT, true, pctRange.maximum);
        });
