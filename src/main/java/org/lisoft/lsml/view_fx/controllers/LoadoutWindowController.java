...
import org.lisoft.lsml.view_fx.controls.EquippablePredicate;
...
public class LoadoutWindowController extends AbstractFXStageController {
	...
	private final LoadoutInfoPaneController loadoutInfoPaneController;
	...
	protected void onLoad() {
		...
		infoScrollPane.setContent(loadoutInfoPaneController.getView());
	}
