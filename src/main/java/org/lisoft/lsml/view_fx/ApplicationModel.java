...
public class ApplicationModel {
    ...
    public final Base64LoadoutCoder coder = new Base64LoadoutCoder(Base64.getEncoder(), Base64.getDecoder(),
            new LoadoutCoderV1(), new LoadoutCoderV2(), new LoadoutCoderV3(errorReporter));
