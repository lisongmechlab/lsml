...
public class FxControlUtils {
	/**
	 * This method facilitates a kind of a three-way binding that may fail. The
	 * value of the check-box is bound to a {@link BooleanExpression}, an attempt to
	 * change the value of the check-box will be sent to a predicate that may fail.
	 * If the predicate fails the check-box retains it's old value.
	 *
	 * @param aCheckBox
	 ...
	 * @param aSuccess
	 *            A predicate that performs the action and returns <code>true</code>
	 *            if it succeeded.
	 */
	...
	/**
	 * This method facilitates a kind of a three-way binding that may fail. The
	 * value of the toggle button is bound to a {@link BooleanExpression}, an
	 * attempt to change the value of the toggle button will be sent to a predicate
	 * that may fail. If the predicate fails the toggle button retains it's old
	 * value.
	 *
	 * @param aToggleButton
	 ...
	 * @param aScene
	 *            The scene to check.
	 * @return True if the user is currently editing any text input type control in
	 *         the scene.
	 */
	 ...
	 * @param aStack
	 *            A {@link CommandStack} to use for executing changes to the garage
	 *            on.
	 * @param aShowValues
	 *            <code>true</code> if the loadouts or drop ships should be shown in
	 *            the tree.
	 * @param aClazz
	 *            The class of T.
	 */
