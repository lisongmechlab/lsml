...
public class FxGraphUtils {
   ...
   */
  public static void setAxisBound(
      Axis<? extends Number> aAxis, double aLB, double aUB, double aStep) {
  ...
  /**
   * Will setup the X and Y {@link Axis} to be tight around the data given by <code>aData</code>.
   * The axis values are quantised as by {@link #setAxisBound(Axis, double, double, double)} with
   * the respective X and Y step.
   *
   ...
   */
  public static void setTightBounds(
      Axis<? extends Number> aXAxis,
      Axis<? extends Number> aYAxis,
      double aXStep,
      double aYStep,
      ObservableList<Series<Double, Double>> aData) {
