 ...
 *
 * <p>FIXME: All pugrades need to have their factions checked against existing faction.
 *
 * @author Li Song
 */
public class CmdSetStructureType extends CmdUpgradeBase {
  ...
  /**
   * Creates a new {@link CmdSetStructureType} that will change the internal structure of a {@link
   * LoadoutStandard}.
   *
  ...
  /**
   * Creates a {@link CmdSetStructureType} that only affects a stand-alone {@link UpgradesMutable}
