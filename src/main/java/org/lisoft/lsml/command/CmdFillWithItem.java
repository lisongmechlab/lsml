...
public class CmdFillWithItem extends CompositeCommand {
   ...
   * @param aLoadoutFactory A {@link LoadoutFactory} used to construct copies in the search process
   *     to fill the {@link Loadout}.
   */
  public CmdFillWithItem(
      MessageDelivery aDelivery,
      Loadout aLoadout,
      Ammunition aAmmoType,
      Ammunition aAmmoHalfType,
   ...
   */
  public CmdFillWithItem(
      MessageDelivery aDelivery, Loadout aLoadout, Item aItem, LoadoutFactory aLoadoutFactory) {
