...
/**
 * This {@link Command} will take the contents from the source {@link GarageDirectory} and merge
 * them into the destination such that all folders and values from the source are added to the
 * destination unless they already exist.
 *
 * <p>Folders are compared as case insensitive and values are compared by <code>equals(Object)
 * </code>.
 *
...
public class CmdGarageMergeDirectories<T extends NamedObject> extends CompositeCommand {
  ...
  public CmdGarageMergeDirectories(
      String aDescription,
      MessageDelivery aMessageTarget,
      GaragePath<T> aDstPath,
