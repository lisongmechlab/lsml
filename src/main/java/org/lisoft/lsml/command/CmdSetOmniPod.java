...
public class CmdSetOmniPod extends CompositeCommand {
   ...
   */
  public CmdSetOmniPod(
      MessageDelivery aMessageDelivery,
      LoadoutOmniMech aLoadout,
      ConfiguredComponentOmniMech aComponentOmniMech,
      OmniPod aOmniPod) {
    super(
        "change omnipod on " + aComponentOmniMech.getInternalComponent().getLocation(),
        aMessageDelivery);
    if (aOmniPod == null) {
  ...
  public void buildCommand() throws EquipException {
    ...
    int jjLeft =
        loadout.getJumpJetsMax() + (newOmniPod.getJumpJetsMax() - oldOmniPod.getJumpJetsMax());
