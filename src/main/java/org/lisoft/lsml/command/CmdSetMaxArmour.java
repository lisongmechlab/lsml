...
public class CmdSetMaxArmour extends CmdLoadoutBase {
  ...
  public CmdSetMaxArmour(
      Loadout aLoadout, MessageDelivery aMessageDelivery, double aRatio, boolean aManualSet) {
  ...
  public void buildCommand() {
    for (ConfiguredComponent component : loadout.getComponents()) {
      ...
      if (component.getInternalComponent().getLocation().isTwoSided()) {
        ...
        addOp(
            new CmdSetArmour(
                messageBuffer, loadout, component, ArmourSide.FRONT, front, manualSet));
        addOp(
            new CmdSetArmour(messageBuffer, loadout, component, ArmourSide.BACK, back, manualSet));
      } else {
