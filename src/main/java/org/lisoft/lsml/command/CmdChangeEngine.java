...
public class CmdChangeEngine extends CompositeCommand {
   ...
   * @param aLoadoutStandard The {@link LoadoutStandard} to modify (Omni 'Mechs have fixed engines
   *     so this command doesn't apply).
   * @param aEngine The new engine to change to, must not be null.
   */
  public CmdChangeEngine(
      MessageDelivery aMessageTarget, LoadoutStandard aLoadoutStandard, Engine aEngine) {
