...
public class BackTrackingSolver<T extends PartialCandidate<T>> {
     ...
     * 
     * The functions {@link #first()} and {@link #next()} together define to search space of the problem. You can think
     * of the search space as a tree structure where {@link #first()} returns the first child of the current node and
     * {@link #next()} returns the right (or left) sibling of the current node. They must be chosen so that every
     * solution of the problem exists in the tree that they describe and that no partial candidate occurrs more than
     * once.
     * 
     * @author Li Song
     * @param <U>
    ...
    public interface PartialCandidate<U extends PartialCandidate<U>> {
         ...
         * 
         * Note: This must not return true if as long as there is any chance that this {@link PartialCandidate} can in
         * some extension satisfy the problem, or the solution may be missed by the solver.
         * 
        ...
        /**
         * Generates the first extension of this partial candidate. For example by choosing a value for the next
         * unknown.
         * 
        ...
        /**
         * Generates the next alternative extension of this partial candidate. For example by changing the value of the
         * last chosen unknown.
         * 
