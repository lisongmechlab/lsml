...
public class RoundedBorders extends AbstractBorder {
    ...
    public RoundedBorders(Insets aMargin, Insets aPadding, int aRadii, boolean aNoTopBevel, boolean aNoBottomBevel) {
        radii = aRadii;
        margin = aMargin;
        insets = new Insets(margin.top + aPadding.top, margin.left + aPadding.left, margin.bottom + aPadding.bottom,
    ...
    public RoundedBorders(int aMargin, int aPadding, int aRadii) {
        this(new Insets(aMargin, aMargin, aMargin, aMargin), new Insets(aPadding, aPadding, aPadding, aPadding),
                aRadii, false, false);
    }
