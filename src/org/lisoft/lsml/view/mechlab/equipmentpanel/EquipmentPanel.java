 ...
 * @author Emily Björk
 */
public class EquipmentPanel extends JPanel implements MessageReceiver, InternalFrameListener {
    ...
    public EquipmentPanel(DesktopPane aDesktop, MessageXBar aXBar) {
        aXBar.attach(this);
