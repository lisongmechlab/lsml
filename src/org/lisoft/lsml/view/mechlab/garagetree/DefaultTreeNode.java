...
class DefaultTreeNode<T> extends AbstractTreeNode {
    final protected List<T> children = new ArrayList<>();

    public DefaultTreeNode(String aName, GarageTreeModel aModel) {
        super(aName, aModel);
    }

    public DefaultTreeNode(String aName, TreeNode aParent, GarageTreeModel aModel) {
