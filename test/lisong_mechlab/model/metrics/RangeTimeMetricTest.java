...
public class RangeTimeMetricTest{
    ...
    * for which {@link RangeTimeMetric#calculate(double, double)} returned the highest value of the ranges determined by
    ...
    * by {@link WeaponRanges#getRanges(LoadoutStandard)}.
    */
   @Test
